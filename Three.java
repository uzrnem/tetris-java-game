import java.awt.*;
class Three extends Box{
	int int0[]={1,0,2,0,1,1,1,2};
	int int1[]={0,0,0,1,1,1,2,1};
	int int2[]={1,2,2,2,2,1,2,0};
	int int3[]={1,0,2,0,3,0,3,1};
	Three(){
		ch='g';
		java.net.URL url = Three.class.getResource("g.png");

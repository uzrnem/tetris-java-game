import java.awt.*;
class Zero extends Box{
	int int0[]={1,0,2,0,1,1,2,1};
	int int1[]={1,0,2,0,1,1,2,1};
	int int2[]={1,0,2,0,1,1,2,1};
	int int3[]={1,0,2,0,1,1,2,1};
	Zero(){
		ch='o';
		java.net.URL url = Zero.class.getResource("o.png");

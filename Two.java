import java.awt.*;
class Two extends Box{
	int int0[]={1,0,2,0,2,1,2,2};
	int int1[]={0,1,0,0,1,0,2,0};
	int int2[]={1,0,1,1,1,2,2,2};
	int int3[]={1,1,2,1,3,1,3,0};
	Two(){
		ch='k';
		java.net.URL url = Two.class.getResource("k.png");

import java.awt.*;
class Four extends Box{
	int int0[]={0,0,1,0,2,0,1,1};
	int int1[]={0,0,0,1,1,1,0,2};
	int int2[]={1,1,2,1,3,1,2,0};
	int int3[]={2,1,3,0,3,1,3,2};
	Four(){
		ch='r';
		java.net.URL url = Four.class.getResource("r.png");
